...
CREATE TABLE session_players (
    ...
    role            ENUM('VILLAGER','WEREWOLF','SEER','WITCH','HUNTER','LITTLE_GIRL') DEFAULT NULL,
...
CREATE TABLE night_actions (
    ...
    session_id  INT NOT NULL,
    player_id   INT NOT NULL,
    action_type ENUM('SEER_REVEAL','WITCH_HEAL','WITCH_KILL','WITCH_PASS','HUNTER_SHOT') NOT NULL,
